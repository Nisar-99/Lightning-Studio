        ...
        return this.each(function () {
            ...
            if (f.sticky && (navPos = nav.offset().top, h <= r && u(window).on("scroll", function () {
                ...
                var i = '<span class="close-menu ' + n + '"><span class="icon-close"></span>' + closeLabel + "</span>",
                    s = '<a href="tel:' + f.phoneBtn + '" class="invisible  call-btn-mobile ' + n + '"><svg id="icon-phone"></svg></a>',
                    t = '<a href="' + f.locationBtn + '" class="invisible  location-btn-mobile ' + n + '" target="_blank"><svg id="icon-location"></svg></i></a>';
