        ...
        <>
                ...
                <header className="border-bottom lh-1 py-3">
                    <div className="text-center">
                        <div data-aos="fade-down"
                            ...
                            <a className="blog-header-logo text-body-emphasis text-decoration-none" href="#">Lightning Studio</a>
                        </div>
                    </div>
                </header>
            ...
            <main className="container">
                ...
                <div className="row py-5">
                    <div className="col-md-12 mx-auto text-center" data-aos="zoom-in-up" data-aos-duration="500">
                        <h4 className="fw-light">Build Salesforce LWC development easy and fastest.</h4>

                        <p className="m-1">A handy Chrome extension designed to simplify Salesforce Lightning Web Component (LWC)
                            development.</p>
                        <p className="">Lightning Studio offers a range of features that make building and managing LWCs faster and
                            more efficient.</p>

                        <p>
                            <a href="https://chromewebstore.google.com/detail/lightning-studio/ehkpneicmpbdejpoancidgkejlkahjgo"
                                target="_blank" className="btn btn-secondary my-2">
                                <i className="fa-brands fa-chrome"></i> Install Now</a>
                        </p>
                    </div>
                </div>

                <div className="row g-5">
                    <div className="col-md-12 mx-auto bg-light-subtle pt-3 pb-3">
                        <h2 className="pb-2 border-bottom fw-bold" data-aos="fade-right" data-aos-duration="500">Features</h2>

                        <div className="row row-cols-1 row-cols-sm-2 row-cols-md-3 row-cols-lg-3 g-4 py-5" data-aos="fade-left" data-aos-duration="500">
                            <div className="col">
                                <h4 className="fw-semibold mb-0">Quick Implementation</h4>
                                <p>If you are a learner and student then this tool will be very useful for you because without
                                    any configuration you can take quick action here.</p>
                            </div>
                            <div className="col">
                                <h4 className="fw-semibold mb-0">Highly Protected Privacy</h4>
                                <p>Your privacy is highly protected. We are not sharing or storing your credentials anywhere.
                                </p>
                            </div>
                            <div className="col">
                                <h4 className="fw-semibold mb-0">Deal with multiple org's</h4>
                                <p>You can work with multiple salesforce organizations at the same time for multitasking.</p>
                            </div>
                            <div className="col">
                                <h4 className="fw-semibold mb-0">Lightning Web Component</h4>
                                <p>Quickly Create, Update and Delete Lightning Message Components.</p>
                            </div>
                            <div className="col">
                                <h4 className="fw-semibold mb-0">Lightning Message Channel</h4>
                                <p>Quickly Create, Update and Delete Lightning Message Channel.</p>
                            </div>
                            <div className="col">
                                <h4 className="fw-semibold mb-0">Apex Class</h4>
                                <p>Create and Update Apex Classes.</p>
                            </div>
                            <div className="col">
                                <h4 className="fw-semibold mb-0">Backup</h4>
                                <p>Download any specific file and folder locally for LWC, LMS and Apex class.</p>
                            </div>
                            <div className="col">
                                <h4 className="fw-semibold mb-0">Code Finder</h4>
                                <p>Quick code search in LWC and Apex classes.</p>
                            </div>
                            <div className="col">
                                <h4 className="fw-semibold mb-0">Themes</h4>
                                <p>Supports many themes with dark and light feature.</p>
                            </div>
            ...
            <main className="container">
                <div className="row g-5">
                    <div className="col-md-12 mx-auto bg-light-subtle pt-5 pb-5">
                        <div className="row">
                            <div className="col-sm-4" data-aos="fade-right" data-aos-duration="500">
                                <svg xmlns="http://www.w3.org/2000/svg" data-name="Layer 1" height="300"
                                    ...
                                    <path
                                        ...
                                        transform="translate(-190.46477 -158)" fill="#536dfe" />
                            ...
                            <div className="col-sm-8 my-auto">
                                <h2 className="fw-bold" data-aos="fade-right" data-aos-duration="500">Security and Privacy</h2>
                                <div data-aos="fade-up-left" data-aos-duration="500">
                                    <p>The LIGHTNING STUDIO browser extension connects directly to Salesforce servers, ensuring
                                        that no data is shared with third parties. It communicates using Salesforce’s official
                                        APIs, meaning it only accesses the data and features that you, as the logged-in user,
                                        are authorized to see.</p>
                                    <p>To improve performance and save your preferences, we store some information in your
                                        browser's localStorage, but none of this data relates to Salesforce objects like
                                        Accounts or Contacts.</p>
                                    <p className="mb-0">The extension uses the same access token from your Salesforce session for
                                        API calls,
                                        requiring permission to read browser cookies for Salesforce domains.</p>
                                    <p>You can verify this by inspecting the source code or monitoring network traffic in your
                                        browser.</p>
            ...
            <main className="container">
                ...
                <div className="row g-5">
                    <div className="col-md-12 mx-auto bg-light-subtle pt-3">
                        <h2 className="pb-2 border-bottom fw-bold" data-aos="fade-right">Mostly Asked Questions</h2>

                        <div className="row row-cols-1" data-aos="fade-right" data-aos-duration="500">
                            <div className="col">
                                    ...
                                    <div className="accordion-item">
                                        <h2 className="accordion-header">
                                            <button className="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                                ...
                                                Unable to use &nbsp; <code>@import</code> &nbsp; with custom objects
                                            </button>
                                        </h2>
                                        <div id="flush-collapseOne" className="accordion-collapse collapse"
                                            data-bs-parent="#accordionFlushExample">
                                            <div className="accordion-body"> Deploy your LWC Component using <span class="badge text-bg-light">Standard Deployment?</span> Salesforce Standard Deployment Mode.</div>
                                        </div>
                                    </div>
                                    <div className="accordion-item">
                                        <h2 className="accordion-header">
                                            <button className="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                                ...
                                                Exception Types:&nbsp;<span class="badge rounded-pill text-bg-warning">FIELD_INTEGRITY_EXCEPTION</span>&nbsp;<span class="badge rounded-pill text-bg-warning">CUSTOM_FIELD_NOT_FOUND</span>&nbsp;<span class="badge rounded-pill text-bg-warning">INVALID_REFERENCE_SOBJECT_FIELD</span>
                                            </button>
                                        </h2>
                                    ...
                                    <div className="accordion-item">
                                        <h2 className="accordion-header">
                                            <button className="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                                ...
                                                Lightning-studio is not working properly. It simply redirects you to the extensions page.
                                            </button>
                                        </h2>
                                        <div id="flush-collapseThree" className="accordion-collapse collapse"
                                            data-bs-parent="#accordionFlushExample">
                                            <div className="accordion-body">Please clear your browser's cache and try again.</div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <div className="row g-5">
                    <div className="col-md-12 mx-auto bg-light-subtle pt-5 pb-5">
                        ...
                        <div className="row">
                            <div className="col-sm-4" data-aos="fade-up-right" data-aos-easing="ease-in-sine" data-aos-duration="500">
                                <svg xmlns="http://www.w3.org/2000/svg" data-name="Layer 1" height="300"
                                    ...
                                    <path id="ea648e8d-1b31-4ae2-9566-f54bfd0d94c9-381" data-name="Path 411"
                                    ...
                                    <path id="b4f9d9e0-1a47-44a2-8a19-0d88a6e9c18f-382" data-name="Path 412"
                                        ...
                                        transform="translate(-231.30512 -178)" fill="#ccc" />
                                    <path id="e168965a-63e1-4676-8cbb-3e09d33a4a3f-383" data-name="Path 413"
                                        ...
                                        transform="translate(-231.30512 -178)" fill="#ccc" />
                                    <path id="af0ff97e-1a3a-4f6f-a511-2c807a938985-384" data-name="Path 414"
                                        ...
                                        transform="translate(-231.30512 -178)" fill="#ccc" />
                                    <path id="e60f2d91-ad3b-421b-94cb-3aa0f5092f21-385" data-name="Path 415"
                                        ...
                                        transform="translate(-231.30512 -178)" fill="#ccc" />
                                    <path id="a5554f8b-57e8-4c3b-815c-c76cc46b61b5-386" data-name="Path 416"
                                        ...
                                        transform="translate(-231.30512 -178)" fill="#ccc" />
                                    <path id="eee68bf7-fbe9-4bfc-85ae-b0141fb14f45-387" data-name="Path 417"
                                        ...
                                        transform="translate(-231.30512 -178)" fill="#ccc" />
                                    <path id="b9a7afa1-162f-46e2-88e2-f572ab59fc71-388" data-name="Path 418"
                                    ...
                                    <path
                                        ...
                                        transform="translate(-231.30512 -178)" fill="#3f3d56" />
                                    <path id="eb40ba0f-f2ca-41e6-ba2e-bd824fb45cdc-389" data-name="Path 411"
                                        ...
                                        transform="translate(-231.30512 -178)" fill="#ccc" />
                                    <path id="ea390b26-798a-41d7-8695-eb41cfeb13d4-390" data-name="Path 412"
                                        ...
                                        transform="translate(-231.30512 -178)" fill="#ccc" />
                                    <path id="f9b4f79e-9356-48bc-89d8-91f80de67df3-391" data-name="Path 413"
                                        ...
                                        transform="translate(-231.30512 -178)" fill="#3f3d56" />
                                    <path id="f3294a48-db04-45e1-afc8-dab6eb28e529-392" data-name="Path 414"
                                        ...
                                        transform="translate(-231.30512 -178)" fill="#ccc" />
                                    <path id="bb6dba8b-bb0a-4f92-a6ea-c6252f741607-393" data-name="Path 415"
                                        ...
                                        transform="translate(-231.30512 -178)" fill="#ccc" />
                                    <path id="b1d451cb-91ad-40cf-876e-6a74c98e5c4f-394" data-name="Path 416"
                                        ...
                                        transform="translate(-231.30512 -178)" fill="#ccc" />
                                    <path id="bcef27e7-bcca-4cc4-a6d4-200e9e04132c-395" data-name="Path 417"
                                        ...
                                        transform="translate(-231.30512 -178)" fill="#ccc" />
                                    <path id="ed29f808-f3a3-4ac8-bd45-563f73aa9d8b-396" data-name="Path 418"
                                    ...
                                    <path
                                        ...
                                        transform="translate(-231.30512 -178)" fill="#3f3d56" />
                                    <path id="ab56b95a-ad0a-4db6-b885-1de339e59248-397" data-name="Path 411"
                                        ...
                                        transform="translate(-231.30512 -178)" fill="#3f3d56" />
                                    <path id="a65ba0e0-92d5-467b-b937-6962ba88422c-398" data-name="Path 412"
                                        ...
                                        transform="translate(-231.30512 -178)" fill="#3f3d56" />
                                    <path id="fb801fe4-3edc-4e65-9957-dec023933e0a-399" data-name="Path 413"
                                        ...
                                        transform="translate(-231.30512 -178)" fill="#ccc" />
                                    <path id="faab0864-6611-44c5-86ab-6dd51d336b1d-400" data-name="Path 413"
                                        ...
                                        transform="translate(-231.30512 -178)" fill="#3f3d56" />
                                    <path id="ada3facf-2b93-40cb-83c6-b6d8dc380c35-401" data-name="Path 414"
                                        ...
                                        transform="translate(-231.30512 -178)" fill="#ccc" />
                                    <path id="a50891a7-c495-4965-ab40-a1f907e5cce2-402" data-name="Path 415"
                                        ...
                                        transform="translate(-231.30512 -178)" fill="#ccc" />
                                    <path id="f645be9d-0c31-4d92-bfb2-feede413f090-403" data-name="Path 416"
                                        ...
                                        transform="translate(-231.30512 -178)" fill="#ccc" />
                                    <path id="f96ba49d-c571-4857-91da-e214cd5ba82f-404" data-name="Path 417"
                                        ...
                                        transform="translate(-231.30512 -178)" fill="#ccc" />
                                    <path id="a7214c6f-9d52-425a-b9ef-635698aec079-405" data-name="Path 418"
                            ...
                            <div className="col-sm-8 my-auto" data-aos="fade-up-left" data-aos-easing="ease-in-sine" data-aos-duration="500">
                                <h2 className="fw-bold">Still Didn’t Find Your Answer?</h2>
                                <p>Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam
                                    nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam</p>
                                <a href="https://github.com/Nisar-99/Lightning-Studio/issues" target="_blank"
                                    className="btn btn-secondary btn-sm">Submit a Ticket</a>
                            </div>
                            ...
                            <div className='card'>
                                <div className="row p-4">
                                    <div className="col-md-5 text-center align-self-center">
                                        <div data-aos="zoom-in-down" data-aos-duration="500">
                                            <p>Need your support, Please review and share.</p>

                                            <a href="https://chromewebstore.google.com/detail/lightning-studio/ehkpneicmpbdejpoancidgkejlkahjgo/reviews"
                                                target="_blank" className="btn btn-outline-primary btn-sm d-md-block">Write a Review</a>

                                            <p className="mt-3 mb-1">Thank you for your support to</p>
                                            <h5 className="fw-bold">LIGHTNING STUDIO</h5>
                                    ...
                                    <div className="col-md-7">
                                        <div data-aos="zoom-in-up" data-aos-duration="500">
                                            <svg xmlns="http://www.w3.org/2000/svg" data-name="Layer 1" height="200"
                                                viewBox="0 0 675.03315 423.65484">
                                                <path
                                                    d="M333.20428,376.23077a9.64558,9.64558,0,0,1-5.68739-1.8833l-13.70575-9.95753a6.64167,6.64167,0,0,0-7.83386,0l-13.70575,9.95753a9.67536,9.67536,0,0,1-14.88925-10.81611l5.23531-16.11171a6.64911,6.64911,0,0,0-2.42065-7.45234l-13.70576-9.95753a9.67538,9.67538,0,0,1,5.6874-17.50249h16.94088a6.64759,6.64759,0,0,0,6.33795-4.60461l5.23531-16.1117a9.675,9.675,0,0,1,18.40371,0l5.23458,16.1117a6.6485,6.6485,0,0,0,6.33868,4.60461h16.94089a9.67538,9.67538,0,0,1,5.68739,17.50249l-13.70575,9.95753a6.64835,6.64835,0,0,0-2.42139,7.45234l5.23531,16.11171a9.52983,9.52983,0,0,1-3.5152,10.81611A9.64507,9.64507,0,0,1,333.20428,376.23077Z"
                                                    transform="translate(-262.48343 -238.17258)" fill="#536dfe" />
                                                <path
                                                    d="M472.09073,376.23077a9.645,9.645,0,0,1-5.68665-1.8833l-13.70576-9.95753a6.65671,6.65671,0,0,0-7.83459,0L431.158,374.34747a9.67485,9.67485,0,0,1-14.88852-10.81611l5.23458-16.11171a6.64911,6.64911,0,0,0-2.42065-7.45234l-13.70576-9.95753a9.67538,9.67538,0,0,1,5.68739-17.50249h16.94089a6.64759,6.64759,0,0,0,6.338-4.60461l5.23531-16.1117a9.675,9.675,0,0,1,18.40371,0l5.23532,16.1117a6.64758,6.64758,0,0,0,6.33794,4.60461H486.497a9.67538,9.67538,0,0,1,5.68739,17.50249l-13.70575,9.95753a6.6491,6.6491,0,0,0-2.42066,7.45234l5.23458,16.11171a9.53055,9.53055,0,0,1-3.51447,10.81611A9.6472,9.6472,0,0,1,472.09073,376.23077Z"
                                                    transform="translate(-262.48343 -238.17258)" fill="#536dfe" />
                                                <path
